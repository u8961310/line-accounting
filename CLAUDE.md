...
### 資料分析強化（🟡 中）
- [ ] 收支年同期比較（YoY）：在月份對比卡或進階分析新增「今年 N 月 vs 去年 N 月」，追蹤長期財務進步
- [ ] 帳單行事曆 .ics 匯出：將信用卡截止日、貸款還款日、固定支出匯出為 .ics，一鍵加入 Google Calendar
- [ ] 財務日記（月度一句話）：每月底讓使用者輸入一句心得，配合數據儲存，年度回顧時對照「說到做到了嗎」
